        ...
        try {
            ...
            while ((tempString = reader.readLine()) != null) {
                ...
                if (tempString.contains("</dimen>")) {
                    ...
                    sw240.append(start).append( num * 1.2).append(end).append("\r\n");
 
                    sw480.append(start).append(num * 1.3).append(end).append("\r\n");
 
                    sw600.append(start).append(num * 1.4).append(end).append("\r\n");
